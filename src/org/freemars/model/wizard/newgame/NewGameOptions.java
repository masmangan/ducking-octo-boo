...
public class NewGameOptions {
    ...
    private TreeMap<TileType, Integer> tileTypes;
    private Vector<Nation> nations;
    private TreeMap<Nation, Color> nationPrimaryColors;
    private TreeMap<Nation, Color> nationSecondaryColors;
    ...
    public Vector<Nation> getNations() {
        return nations;
    }
