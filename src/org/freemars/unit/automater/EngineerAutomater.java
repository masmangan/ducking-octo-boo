...
public class EngineerAutomater extends AbstractUnitAutomater {
    ...
    private EngineerAutomaterCoordinateHelper engineerAutomaterCoordinateHelper;
    ...
    public void automate() {
        if (getUnit().getCurrentOrder() == null) {
            ...
            if (possibleAssignments.size() > 0) {
                ...
                freeMarsController.execute(new UnitAdvanceToCoordinateCommand(freeMarsController.getFreeMarsModel().getRealm(), getUnit(), targetCoordinate));
                ...
                String log = "Engineer automater for \"" + getUnit().getName() + "\" could not find any assignments in turn " + freeMarsController.getFreeMarsModel().getNumberOfTurns() + ". Removing automater for \"" + getUnit().getName() + "\".";
                Logger.getLogger(EngineerAutomater.class).info(log);
    ...
    private boolean isCoordinateTargetedByEngineer(Coordinate coordinate) {
        UnitType engineerType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(1);
