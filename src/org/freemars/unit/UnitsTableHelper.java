...
public class UnitsTableHelper {
    ...
    public void updateUnitTypeCounts() {
        ...
        if (player != null) {
            ...
            while (unitTypeIterator.hasNext()) {
                ...
                Image unitImage = FreeMarsImageManager.getInstance().getImage(unitType);
    ...
    private ImageIcon getUnitIcon(Unit unit) {
        Image image = FreeMarsImageManager.getInstance().getImage(unit);
        ...
        if (unit.getCoordinate() != null) {
            ...
            if (unitLocation != null) {
                if (unitLocation.equals(Location.MARS_ORBIT)) {
                    ...
                    return "Traveling to Earth (ETA " + freeMarsController.getFreeMarsModel().getEarthFlightModel().findETA(unit) + " months)";
                    ...
                    if (unitOrder != null && unitOrder instanceof RelocateUnitOrder) {
                        ...
                        if (relocateUnitOrder.getLandOnColony() != null) {
                            return "Traveling to " + relocateUnitOrder.getLandOnColony().getName() + " (ETA " + freeMarsController.getFreeMarsModel().getEarthFlightModel().findETA(unit) + " months)";
                        }
                    }
                    return "Traveling to Mars orbit (ETA " + freeMarsController.getFreeMarsModel().getEarthFlightModel().findETA(unit) + " months)";
