...
public class ExpeditionaryForcePlayer extends FreeMarsPlayer {
    ...
    public static final int BASE_INFANTRY_COUNT = 6;
    public static final int BASE_MECH_COUNT = 8;
    public static final int BASE_LGT_COUNT = 4;

    public static final int MAX_INFANTRY_COUNT = 24;
    public static final int MAX_MECH_COUNT = 24;
    public static final int MAX_LGT_COUNT = 18;
