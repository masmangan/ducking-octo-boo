...
public class ColonyTileWorkForceManagerForExportableResources {
    ...
    private void fillProducableExportResources(FreeMarsColony freeMarsColony) {
        ...
        String[] tileProducableExportResourceNames = new String[]{"Iron", "Silica", "Minerals", "Magnesium"};
        for (String tileProducableExportResourceName : tileProducableExportResourceNames) {
            ...
            if (freeMarsColony.getRemainingCapacity(tileProducableExportResource) > 2000) {
    ...
    class AssignmentOption implements Comparable<AssignmentOption> {
        ...
        public int getIncome() {
            ...
            int price = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthBuysAtPrice(resource);
