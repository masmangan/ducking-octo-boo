...
import org.freerealm.executor.command.UnitAdvanceAndAttackToCoordinateCommand;
...
public class ExpeditionaryForceDecisionModel {
    ...
    public void play() throws Exception {
        ...
        if (targetPlayer.hasDeclaredIndependence()) {
            ...
            UnitType LGTType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType("LGT");
