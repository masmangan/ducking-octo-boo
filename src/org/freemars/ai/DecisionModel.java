...
import org.freerealm.executor.command.AddSettlementImprovementCommand;
...
public class DecisionModel {
    ...
    private ArrayList<UnitType> manageableSpaceshipTypes;
    ...
    public ArrayList<UnitType> getManageableSpaceshipTypes() {
        if (manageableSpaceshipTypes == null) {
            manageableSpaceshipTypes = new ArrayList<UnitType>();
    ...
    private void checkEarthSupport() {
        ...
        if (aiPlayer.canReceiveFreeTransporter()) {
            ...
            if (colony != null) {
                UnitType transporterType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType("Transporter");
    ...
    private void logColonies() {
        ...
        while (iterator.hasNext()) {
            ...
            while (workforceIterator.hasNext()) {
                ...
                log.append(workForce.getCoordinate());
                log.append(" - ");
    ...
    private void logUnits() {
        ...
        while (iterator.hasNext()) {
            ...
            if (unit.getStatus() == Unit.UNIT_ACTIVE) {
                log.append("ACTIVE");
            } else if (unit.getStatus() == Unit.UNIT_SUSPENDED) {
            ...
            Location location = freeMarsController.getFreeMarsModel().getEarthFlightModel().getUnitLocation(unit);
            if (location != null) {
