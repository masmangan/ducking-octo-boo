...
public class ChooseNationsPanel extends JPanel {
    ...
    private Vector<NationCheckBoxPanel> nationOptions;

    public ChooseNationsPanel() {
        nationOptions = new Vector<NationCheckBoxPanel>();
        iconLabel = new JLabel();
        contentPanel = getContentPanel();
        contentPanel.setBorder(new EmptyBorder(new Insets(10, 10, 10, 10)));
        setLayout(new BorderLayout());
        icon = new ImageIcon(FreeMarsImageManager.getInstance().getImage(FreeMarsImageManager.NEW_GAME_WIZARD_3));
        if (icon != null) {
    ...
    public void populatePlayerOptionsPanel(NationManager nationManager, Vector<Nation> selectedNations) {
    ...
    public Vector<NationCheckBoxPanel> getNationOptions() {
