    ...
    public void setUnit(Unit unit) {
        ...
        if (unit != null) {
            if (unit.getContainedPopulation() > 0) {
                ...
                Image image = FreeMarsImageManager.getInstance().getImage("COLONIST");
            ...
            Iterator<UnitType> iterator = freeMarsModel.getRealm().getUnitTypeManager().getUnitTypesIterator();
