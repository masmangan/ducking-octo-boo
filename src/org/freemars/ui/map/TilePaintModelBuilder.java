...
public class TilePaintModelBuilder {
    ...
    public static TilePaintModel buildTilePaintModel(Graphics graphics, FreeMarsModel freeMarsModel, Coordinate tileCoordinate, boolean paintUnits) {
        ...
        if (tileCoordinate != null) {
            ...
            if (tile != null) {
                ...
                updateTilePaintModel(graphics, tilePaintModel, freeMarsModel, tile, paintUnits);
            }
        }
    ...
    public static TilePaintModel buildTilePaintModel(Graphics graphics, FreeMarsModel freeMarsModel, Coordinate tileCoordinate) {
        return buildTilePaintModel(graphics, freeMarsModel, tileCoordinate, true);
    }

    public static void updateTilePaintModel(Graphics graphics, TilePaintModel tilePaintModel, FreeMarsModel freeMarsModel, Tile tile, boolean paintUnits) {
        if (tilePaintModel != null) {
            ...
            if (displayUnexploredTiles || freeMarsModel.getRealm().getPlayerManager().getActivePlayer().isCoordinateExplored(tilePaintModel.getTileCoordinate())) {
                buildModelForExploredTile(graphics, tilePaintModel, freeMarsModel, tilePaintModel.getTileCoordinate(), tile, paintUnits);
            } else {
    ...
    private static void buildModelForExploredTile(Graphics graphics, TilePaintModel tilePaintModel, FreeMarsModel freeMarsModel, Coordinate tileCoordinate, Tile tile, boolean paintUnits) {
        ...
        if (paintUnits) {
            buildModelForTileUnits(graphics, tilePaintModel, freeMarsModel, tile);
        }
        checkUnitPath(tilePaintModel, freeMarsModel, tileCoordinate, tile);
        if (tile.getCollectable() != null) {
            Image collectableImage = FreeMarsImageManager.getInstance().getImage("SPACESHIP_DEBRIS");
                ...
                if (adjacentCoordinate != null) {
                    ...
                    if (displayUnexploredTiles || freeMarsModel.getActivePlayer().isCoordinateExplored(adjacentCoordinate)) {
                        ...
                        if (adjacentTile == null || (adjacentTile != null && adjacentTile.getType().getId() <= tile.getType().getId())) {
                            Image transitionImage = FreeMarsImageManager.getInstance().getImage("TILE_" + adjacentTile.getType().getName().replaceAll(" ", "") + "_" + direction.getShortName());
    ...
    private static void buildModelForTileColony(TilePaintModel tilePaintModel, Tile tile) {
        ...
        if (tile.getSettlement() != null) {
            Image colonyImage = FreeMarsImageManager.getInstance().getImage(tile.getSettlement());
    ...
    private static void buildModelForTileVegetation(TilePaintModel tilePaintModel, FreeMarsModel viewModel, Coordinate tileCoordinate, Tile tile) {
        ...
        if (tile.getVegetation() != null) {
            Image vegetationImage = FreeMarsImageManager.getInstance().getImage(tile.getVegetation());
    ...
    private static void buildModelForTileBonusResource(TilePaintModel tilePaintModel, FreeMarsModel viewModel, Coordinate tileCoordinate, Tile tile) {
        ...
        if (tile.getBonusResource() != null) {
            Image resourceBonusImage = FreeMarsImageManager.getInstance().getImage(tile.getBonusResource());
    ...
    private static void buildModelForTileImprovement(TilePaintModel tilePaintModel, FreeMarsModel freeMarsModel, Coordinate tileCoordinate, Tile tile) {
        ...
        while (improvements.hasNext()) {
            ...
            if (!improvement.equals(road)) {
                Image improvementImage = FreeMarsImageManager.getInstance().getImage(improvement);
    ...
    private static void buildModelForTileTerritoryBorder(TilePaintModel tilePaintModel, FreeMarsModel freeMarsModel, Coordinate tileCoordinate) {
        ...
        if (freeMarsModel.getTileOwner(tileCoordinate) != null) {
            Player tileOwner = freeMarsModel.getTileOwner(tileCoordinate);
            ...
            for (Direction direction : RealmConstants.directions) {
                ...
                if (neighborCoordinate == null || freeMarsModel.getTileOwner(neighborCoordinate) == null || !freeMarsModel.getTileOwner(neighborCoordinate).equals(tileOwner)) {
    ...
    public static void buildModelForTileUnits(Graphics graphics, TilePaintModel tilePaintModel, FreeMarsModel freeMarsModel, Tile tile) {
        tilePaintModel.setUnitImage(null);
        tilePaintModel.setPaintingActiveUnitIndicator(false);
        if (tile.getNumberOfUnits() > 0) {
            Unit unitToPaint = findUnitToPaint(freeMarsModel, tile);
            if (unitToPaint != null) {
                ...
                if ((unitToPaint.getCurrentOrder() != null) && (unitToPaint.getCurrentOrder() instanceof Sentry)) {
                    unitImage = FreeMarsImageManager.getInstance().getImage(unitToPaint, true);
                } else {
                    unitImage = FreeMarsImageManager.getInstance().getImage(unitToPaint, false);
                }
                ...
                Image unitPlayerNationFlagImage = FreeMarsImageManager.getInstance().getImage(unitToPaint.getPlayer().getNation());
    ...
    private static Unit findUnitToPaint(FreeMarsModel freeMarsModel, Tile tile) {
        ...
        if (tile.hasImprovement(road)) {
            ...
            if (north != null) {
                ...
                if (northTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_N");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (south != null) {
                ...
                if (southTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_S");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (east != null) {
                ...
                if (eastTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_E");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (west != null) {
                ...
                if (westTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_W");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (northWest != null) {
                ...
                if (northWestTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_NW");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (northEast != null) {
                ...
                if (northEastTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_NE");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (southWest != null) {
                ...
                if (southWestTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_SW");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
            ...
            if (southEast != null) {
                ...
                if (southEastTile.hasImprovement(road)) {
                    Image improvementImage = FreeMarsImageManager.getInstance().getImage("IMPROVEMENT_road_SE");
                    tilePaintModel.addTerrainImprovementImage(improvementImage);
                }
            }
