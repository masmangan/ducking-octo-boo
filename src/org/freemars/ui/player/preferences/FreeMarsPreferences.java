...
public class FreeMarsPreferences extends Properties {
    ...
    public void savePreferences() {
        StringBuffer preferencesFileContent = getPreferencesFileContent();
        try {
    ...
    private StringBuffer getPreferencesFileContent() {
        StringBuffer preferencesFileContent = new StringBuffer();
        ...
        preferencesFileContent.append("\n");
        preferencesFileContent.append("full_screen=" + getProperty("full_screen") + "\n");
        preferencesFileContent.append("display_unit_move_animation=" + getProperty("display_unit_move_animation") + "\n");
        preferencesFileContent.append("display_player_nation_flags_on_units=" + getProperty("display_player_nation_flags_on_units") + "\n");
