    ...
    public void setPopulationChangeStatus(int populationChangeStatus) {
        ...
        switch (populationChangeStatus) {
            case POPULATION_INCREASED:
                icon = new ImageIcon(FreeMarsImageManager.getInstance().getImage("GREEN_UP_ARROW"));
                break;
            case POPULATION_DECREASED:
                icon = new ImageIcon(FreeMarsImageManager.getInstance().getImage("RED_DOWN_ARROW"));
                break;
            case POPULATION_EQUAL:
            default:
                icon = new ImageIcon(FreeMarsImageManager.getInstance().getImage("BLUE_EQUAL_ARROW"));
                break;
        }
