...
public class MapMenu extends JMenuBar {
    ...
    public void update() {
        ...
        if (player != null) {
            getPlayerStatusInfoPanel().setNationFlag(FreeMarsImageManager.getInstance().getImage(player.getNation()));
    ...
    public void setDisplayOrbitAction(Action action) {
        ...
        getDisplayOrbitButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("MARS_16x16")));
    }
    ...
    public void setDisplayEarthAction(Action action) {
        ...
        getDisplayEarthButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("EARTH_16x16")));
    }
    ...
    public void setZoomLevelMenuActions(Vector<Action> actionsVector) {
        for (int i = 0; i < getZoomLevelMenuItems().length; i++) {
            getZoomLevelMenuItems()[i].setAction(actionsVector.get(i));
        }
    }
