...
public class FreeStarportDialog extends FreeMarsDialog {
    ...
    private ImagePanel getStarportImagePanel() {
        if (starportImagePanel == null) {
            starportImagePanel = new ImagePanel(FreeMarsImageManager.getInstance().getImage(freeMarsController.getFreeMarsModel().getRealm().getSettlementImprovementManager().getImprovement("Starport")));
