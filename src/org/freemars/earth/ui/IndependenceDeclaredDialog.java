...
public class IndependenceDeclaredDialog extends FreeMarsImageDialog {
    ...
    public IndependenceDeclaredDialog(Frame owner) {
        super(owner);
        setImagePreferredSize(new Dimension(130, 250));
        setImage(FreeMarsImageManager.getInstance().getImage("INDEPENDENCE_DECLARED"));
        appendText("<br>");
        ...
        appendText("We expect Earth expeditionary force to <b>land in 8 months</b>. ");
