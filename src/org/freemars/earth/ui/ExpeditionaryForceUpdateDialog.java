...
public class ExpeditionaryForceUpdateDialog extends FreeMarsDialog {
    ...
    public ExpeditionaryForceUpdateDialog(Frame owner, HashMap<UnitType, Integer> expeditionaryForceUpdate) {
        super(owner);
    ...
    private JPanel getMainPanel() {
        if (mainPanel == null) {
            ...
            Iterator<UnitType> iterator = expeditionaryForceUpdate.keySet().iterator();
