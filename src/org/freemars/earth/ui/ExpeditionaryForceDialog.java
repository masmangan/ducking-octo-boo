...
public class ExpeditionaryForceDialog extends FreeMarsDialog {
    ...
    private FreeMarsPlayer activePlayer;
    private ExpeditionaryForcePlayer expeditionaryForcePlayer;

    public ExpeditionaryForceDialog(Frame owner, FreeMarsPlayer activePlayer, ExpeditionaryForcePlayer expeditionaryForcePlayer) {
        super(owner);
        setModal(true);
