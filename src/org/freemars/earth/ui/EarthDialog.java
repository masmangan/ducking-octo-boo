...
public class EarthDialog extends FreeMarsDialog {
    ...
    public void update(int updateType) {
        ...
        switch (updateType) {
            case EarthFlightModel.UNIT_RELOCATION_UPDATE:
                getUnitCargoPanel().setVisible(false);
                updateUnitLocations();
                updateFinanceColonistsButtons();
                break;
            case EarthFlightModel.BUY_SELL_UPDATE:
                updateUnitCargo();
                updateUnitPurchasePanel();
                updateFinanceColonistsButtons();
                getEarthPricesPanel().update();
                break;
            case EarthFlightModel.UNIT_SELECTION_UPDATE:
                Unit selectedUnit = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthDialogSelectedUnit();
                ContainerProperty containerProperty = (ContainerProperty) selectedUnit.getType().getProperty("ContainerProperty");
                EarthFlightProperty earthFlightProperty = (EarthFlightProperty) selectedUnit.getType().getProperty("EarthFlight");
                ...
                updateFinanceColonistsButtons();
                break;
            case EarthFlightModel.PURCHASE_EARTH_UNIT_UPDATE:
            case EarthFlightModel.SELL_UNIT_TO_EARTH_UPDATE:
                getUnitCargoPanel().setVisible(false);
                updateUnitLocations();
                updateUnitPurchasePanel();
                break;
        ...
        while (iterator.hasNext()) {
            ...
            if (unit.getPlayer().equals(freeMarsController.getFreeMarsModel().getRealm().getPlayerManager().getActivePlayer())) {
                ...
                if (location.equals(Location.EARTH)) {
                    ...
                    toggleButton.setText("<html><table><tr><td bgcolor='#FFEEEE'>E.T.A " + freeMarsController.getFreeMarsModel().getEarthFlightModel().findETA(unit) + "</td></tr></table></html>");
                    toggleButton.setToolTipText("");
                    getToEarthPanel().add(toggleButton);
                } else if (location.equals(Location.TRAVELING_TO_MARS)) {
                    toggleButton.setFocusable(false);
                    String buttonText = "<html><table><tr><td bgcolor='#FFEEEE'>E.T.A " + freeMarsController.getFreeMarsModel().getEarthFlightModel().findETA(unit);
                    buttonText = buttonText + "<br>" + freeMarsController.getFreeMarsModel().getEarthFlightModel().findDestination(unit) + "</td></tr></table></html>";
                    toggleButton.setText(buttonText);
                    toggleButton.setToolTipText("");
                    getToMarsPanel().add(toggleButton);
                }
                Image unitImage = FreeMarsImageManager.getInstance().getImage(unit);
    ...
    private void updateFinanceColonistsButtons() {
        ...
        if (selectedUnit != null) {
            ContainerProperty containerProperty = (ContainerProperty) selectedUnit.getType().getProperty("ContainerProperty");
            EarthFlightProperty earthFlightProperty = (EarthFlightProperty) selectedUnit.getType().getProperty("EarthFlight");
            Location location = freeMarsController.getFreeMarsModel().getEarthFlightModel().getUnitLocation(selectedUnit);
            if (location != null && location.equals(Location.EARTH) && containerProperty != null && earthFlightProperty != null) {
                ...
                Player player = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthDialogSelectedUnit().getPlayer();
    ...
    private ImagePanel getUnitInfoPanel() {
        if (unitInfoPanel == null) {
            unitInfoPanel = new ImagePanel(FreeMarsImageManager.getInstance().getImage(FreeMarsImageManager.EARTH_BACKGROUND));
    ...
    private JButton getBuyShuttleButton() {
        if (buyShuttleButton == null) {
            ...
            UnitType unitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(6);
            buyShuttleButton.setAction(new BuyUnitFromEarthAction(freeMarsController, this, unitType));
            String unitPrice = new DecimalFormat().format(freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(unitType));
            buyShuttleButton.setText("<html>Shuttle<br>" + unitPrice + "</html>");
            Image shuttleImage = FreeMarsImageManager.getInstance().getImage("UNIT_6_SW");
    ...
    private JButton getBuyMechButton() {
        if (buyMechButton == null) {
            ...
            UnitType unitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(5);
            ...
            Image mechImage = FreeMarsImageManager.getInstance().getImage("UNIT_5_SW");
    ...
    private JButton getBuyFreighterButton() {
        if (buyFreighterButton == null) {
            ...
            UnitType unitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(7);
            ...
            Image scoutImage = FreeMarsImageManager.getInstance().getImage("UNIT_7_SW");
    ...
    private JButton getBuyBulkFreighterButton() {
        if (buyBulkFreighterButton == null) {
            ...
            UnitType unitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(8);
            ...
            Image bulkFreighterImage = FreeMarsImageManager.getInstance().getImage("UNIT_8_SW");
    ...
    private JButton getBuyColonizerButton() {
        if (buyColonizerButton == null) {
            ...
            UnitType unitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(0);
            ...
            Image colonizerImage = FreeMarsImageManager.getInstance().getImage("UNIT_0_SW");
    ...
    private JButton getBuyTransporterButton() {
        if (buyTransporterButton == null) {
            ...
            UnitType unitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType(2);
            ...
            Image colonizerImage = FreeMarsImageManager.getInstance().getImage("UNIT_2_SW");
            colonizerImage = FreeMarsImageManager.createResizedCopy(colonizerImage, -1, 50, false, this);
    ...
    private void updateUnitPurchasePanel() {
        ...
        UnitType shuttleUnitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType("Shuttle");
        int shuttlePrice = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(shuttleUnitType);
        if (player.getWealth() >= shuttlePrice) {
            getBuyShuttleButton().setEnabled(true);
        } else {
            getBuyShuttleButton().setEnabled(false);
        }
        UnitType freighterUnitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType("Freighter");
        int freighterPrice = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(freighterUnitType);
        ...
        UnitType bulkFreighterUnitType = freeMarsController.getFreeMarsModel().getRealm().getUnitTypeManager().getUnitType("Bulk freighter");
        int bulkFreighterPrice = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(bulkFreighterUnitType);
        ...
        int mechPrice = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(mechUnitType);
        ...
        int colonizerPrice = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(colonizerUnitType);
        ...
        int transporterPrice = freeMarsController.getFreeMarsModel().getEarthFlightModel().getEarthSellsAtPrice(transporterUnitType);
