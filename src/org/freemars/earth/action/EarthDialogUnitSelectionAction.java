...
public class EarthDialogUnitSelectionAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        freeMarsController.getFreeMarsModel().getEarthFlightModel().setEarthDialogSelectedUnit(unit);
        earthDialog.update(EarthFlightModel.UNIT_SELECTION_UPDATE);
        JPopupMenu popup = new JPopupMenu();
        if (unit.getType().getProperty("EarthFlight") != null) {
            ...
            JMenu goToMarsCityMenu = new JMenu("Go to Mars colony");
            ...
            while (iterator.hasNext()) {
                ...
                if (settlement.hasImprovementType(starPortImprovementType)) {
                    ...
                    goToMarsCityMenu.add(marsColonyMenuItem);
                }
            }
