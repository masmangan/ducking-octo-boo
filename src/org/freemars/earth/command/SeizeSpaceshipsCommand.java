 ...
 * @author Deniz ARIKAN
 */
public class SeizeSpaceshipsCommand extends AbstractCommand {

    private FreeMarsController freeMarsController;
    private FreeMarsPlayer freeMarsPlayer;
    private String[] seizedUnitTypeNames = {"Shuttle", "Freighter", "Bulk freighter"};

    public SeizeSpaceshipsCommand(FreeMarsController freeMarsController, FreeMarsPlayer freeMarsPlayer) {
    ...
    public CommandResult execute() {
        ...
        if (seizedUnits.size() > 0) {
            commandResult = new CommandResult(CommandResult.RESULT_OK, "", FreeMarsModel.SPACESHIPS_SEIZED_UPDATE);
