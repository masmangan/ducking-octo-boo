...
public class ColonyDialogHeaderPanel extends JPanel {
    ...
    public void setPreviousColonyButtonAction(Action action) {
        ...
        getPreviousColonyButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("PREVIOUS_COLONY")));
    }
    ...
    public void setNextColonyButtonAction(Action action) {
        ...
        getNextColonyButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("NEXT_COLONY")));
    }
    ...
    public void setRenameButtonAction(Action action) {
        ...
        getRenameButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_RENAME")));
    }

    public void setHelpButtonAction(Action action) {
        getHelpButton().setAction(action);
        getHelpButton().setText("");
        Image helpImage = FreeMarsImageManager.getInstance().getImage("HELP");
    ...
    private JToggleButton getAutomanageWaterToggleButton() {
        if (automanageWaterToggleButton == null) {
            Image grayScaleImage = FreeMarsImageManager.getInstance().getImage("RESOURCE_0", true);
            ...
            Image image = FreeMarsImageManager.getInstance().getImage("RESOURCE_0");
    ...
    private JToggleButton getAutomanageFoodToggleButton() {
        if (automanageFoodToggleButton == null) {
            Image grayScaleImage = FreeMarsImageManager.getInstance().getImage("RESOURCE_1", true);
            grayScaleImage = FreeMarsImageManager.createResizedCopy(grayScaleImage, -1, 24, false, this);
            ImageIcon grayScaleImageIcon = new ImageIcon(grayScaleImage);
            Image image = FreeMarsImageManager.getInstance().getImage("RESOURCE_1");
            image = FreeMarsImageManager.createResizedCopy(image, -1, 24, false, this);
            ImageIcon imageIcon = new ImageIcon(image);
    ...
    private JToggleButton getAutoUseFertilizerToggleButton() {
        if (autoUseFertilizerToggleButton == null) {
            Image grayScaleImage = FreeMarsImageManager.getInstance().getImage("RESOURCE_5", true);
            grayScaleImage = FreeMarsImageManager.createResizedCopy(grayScaleImage, -1, 24, false, this);
            ImageIcon grayScaleImageIcon = new ImageIcon(grayScaleImage);
            Image image = FreeMarsImageManager.getInstance().getImage("RESOURCE_5");
            image = FreeMarsImageManager.createResizedCopy(image, -1, 24, false, this);
            ImageIcon imageIcon = new ImageIcon(image);
