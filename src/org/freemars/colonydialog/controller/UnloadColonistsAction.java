...
import org.freemars.command.UnloadColonistsCommand;
 ...
 * @author arikande
 */
public class UnloadColonistsAction extends AbstractAction {

    private final FreeMarsController freeMarsController;
    private final ColonyDialogModel colonyDialogModel;
    private final int numberOfColonists;

    public UnloadColonistsAction(FreeMarsController freeMarsController, ColonyDialogModel colonyDialogModel, int numberOfColonists) {
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         */
        freeMarsController.execute(new UnloadColonistsCommand(freeMarsController, colonyDialogModel.getColony(), colonyDialogModel.getSelectedUnit(), numberOfColonists));
