...
public class DisplayBuyProductionDialogAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int productionCost = new SettlementBuildableCostCalculator(freeMarsColony.getCurrentProduction(), new SettlementModifier[]{freeMarsColony.getPlayer()}).getCost();
        ...
        Image image = FreeMarsImageManager.getInstance().getImage(currentProduction);
