...
public class ColonyImprovementToggleButton extends JToggleButton {
    ...
    private SettlementImprovement colonyImprovement;
    ...
    public ColonyImprovementToggleButton(ColonyDialogModel colonyDialogModel, SettlementImprovement colonyImprovement) {
        ...
        BufferedImage resizedImprovementImage = FreeMarsImageManager.createResizedCopy(FreeMarsImageManager.getInstance().getImage(colonyImprovement.getType(), !colonyImprovement.isEnabled()), -1, 70, false, this);
