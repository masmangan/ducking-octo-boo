...
public class ColonyProductionManagementPanel extends JPanel {
    ...
    public void update() {
        ...
        if (currentProduction != null) {
            ...
            if (currentProduction instanceof UnitType) {
                getContiuousProductionCheckBox().setSelected(true);
                getContiuousProductionCheckBox().setEnabled(true);
            }
            int productionCost = new SettlementBuildableCostCalculator(model.getColony().getCurrentProduction(), new SettlementModifier[]{model.getColony().getPlayer()}).getCost();
