...
public class ColonyManagerDialog extends FreeMarsDialog {
    ...
    public void setGrowthButtonAction(Action action) {
        ...
        getGrowthButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_MANAGER_GROWTH")));
    }
    ...
    public void setProductionButtonAction(Action action) {
        ...
        getProductionButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_MANAGER_PRODUCTION")));
    }
    ...
    public void setManufacturingButtonAction(Action action) {
        ...
        getManufacturingButtonButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_MANAGER_MANUFACTURING")));
    }
    ...
    public void setResourcesButtonAction(Action action) {
        ...
        getResourcesButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_MANAGER_RESOURCES")));
    }
    ...
    public void setImprovementsButtonAction(Action action) {
        ...
        getImprovementsButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_MANAGER_IMPROVEMENTS")));
    }

    public void setGarrisonButtonAction(Action action) {
        getGarrisonButton().setAction(action);
        getGarrisonButton().setText("Garrison");
        getGarrisonButton().setIcon(new ImageIcon(FreeMarsImageManager.getInstance().getImage("COLONY_MANAGER_GARRISON")));
    }
