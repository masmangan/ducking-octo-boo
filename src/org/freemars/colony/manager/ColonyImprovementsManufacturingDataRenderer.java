...
public class ColonyImprovementsManufacturingDataRenderer extends JPanel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        Vector<SettlementImprovementResourceProductionModel> manufacturingData = (Vector<SettlementImprovementResourceProductionModel>) value;
        for (SettlementImprovementResourceProductionModel settlementImprovementResourceProductionModel : manufacturingData) {
            ...
            Image settlementImprovementImage = FreeMarsImageManager.getInstance().getImage(settlementImprovement);
            ...
            if (settlementImprovementType.getInputResourceCount() > 0) {
                ...
                while (inputResourcesIterator.hasNext()) {
                    ...
                    for (int i = 0; i < settlementImprovementType.getInputQuantity(resource); i++) {
                        ...
                        if (i > ratio || ratio == 0) {
                            Image resourceNotEnoughImage = FreeMarsImageManager.getInstance().getImage("RESOURCE_NOT_ENOUGH");
                ...
                Image rightArrowImage = FreeMarsImageManager.getInstance().getImage("RESOURCE_PRODUCTION_RIGHT_ARROW");
