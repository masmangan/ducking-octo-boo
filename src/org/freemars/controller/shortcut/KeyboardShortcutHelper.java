...
import org.freemars.controller.action.DisplayDiplomacyDialogAction;
...
public class KeyboardShortcutHelper {
    ...
    public static void assignKeyboardShortcuts(JComponent component, FreeMarsController controller) {
        assignFileShortcuts(component, controller);
        assignGovernmentShortcuts(component, controller);
        assignMapDisplayShortcuts(component, controller);
        assignUnitMovementShortcuts(component, controller);
        assignUnitOrderShortcuts(component, controller);
        assignEarthFlightShortcuts(component, controller);
    }

    private static void assignFileShortcuts(JComponent component, FreeMarsController controller) {
        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_N, KeyEvent.CTRL_DOWN_MASK), "NewGame");
        component.getActionMap().put("NewGame", new NewGameAction(controller));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_S, KeyEvent.CTRL_DOWN_MASK), "Save");
        component.getActionMap().put("Save", new SaveGameAction(controller));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_F8, 0), "QuickSave");
        component.getActionMap().put("QuickSave", new QuickSaveGameAction(controller));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_L, KeyEvent.CTRL_DOWN_MASK), "Load");
        component.getActionMap().put("Load", new LoadGameAction(controller));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_F9, 0), "QuickLoad");
        component.getActionMap().put("QuickLoad", new QuickLoadGameAction(controller));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "EndTurn");
        component.getActionMap().put("EndTurn", new EndTurnWithEnterAction(controller));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_F1, 0), "DisplayHelpContents");
        component.getActionMap().put("DisplayHelpContents", new DisplayHelpContentsAction(controller, null));

        component.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_Q, KeyEvent.CTRL_DOWN_MASK), "QuitGame");
        component.getActionMap().put("QuitGame", new ExitGameAction(controller));
    }
