...
public class MapPanelMouseListener extends MouseInputAdapter {
    ...
    private void handleLeftClick(MouseEvent mouseEvent) {
        ...
        if (tile.getSettlement() != null) {
            ...
            freeMarsController.execute(new SetActiveUnitCommand(freeMarsController.getFreeMarsModel().getActivePlayer(), unit));
        }
    }
    ...
    private void handleRightClick(MouseEvent mouseEvent) {
        ...
        if (tile != null) {
            ...
            if (tile.getVegetation() != null) {
                ...
                vegetationMenuItem.setAction(new DisplayHelpContentsAction(freeMarsController, "Vegetation." + tile.getVegetation().getName().replaceAll(" ", "_")));
                vegetationMenuItem.setText(tile.getVegetation().getName());
    ...
    private void showUnitPath(MouseEvent e) {
        ...
        if ((mousePointerTileCoordinate == null) || (checkCoordinate.compareTo(mousePointerTileCoordinate) != 0)) {
            ...
            if (unit != null) {
                Path path = freeMarsController.getFreeMarsModel().getRealm().getPathFinder().findPath(unit, mousePointerTileCoordinate, false);
