    ...
    public CommandResult execute() {
        ...
        if (coordinate != null) {
            ...
            if (tilePaintModel != null) {
                ...
                TilePaintModelBuilder.buildModelForTileUnits(freeMarsController.getGameFrame().getMapPanel().getGraphics(), tilePaintModel, freeMarsController.getFreeMarsModel(), tile);
                freeMarsController.executeViewCommand(new RepaintMapPanelCommand(freeMarsController));
            }
        }
        long executionTime = System.currentTimeMillis() - startTime;
        if (executionTime > 10) {
            logger.info("UpdateTilePaintModelUnitsCommand executed in " + executionTime + " miliseconds for coordinate " + coordinate + ".");
        }
