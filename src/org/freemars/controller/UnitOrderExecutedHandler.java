 ...
 * @author Deniz ARIKAN
 */
public class UnitOrderExecutedHandler implements ControllerUpdateHandler {
    ...
    public void handleUpdate(FreeMarsController freeMarsController, CommandResult commandResult) {
        ...
        if (updateNeeded(freeMarsController, unit)) {
            ...
            freeMarsController.executeViewCommand(new UpdateCoordinatePaintModelCommand(freeMarsController, updateCoordinates, false));
