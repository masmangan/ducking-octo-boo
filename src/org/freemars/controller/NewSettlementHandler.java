...
import org.freerealm.executor.command.AddTileImprovementCommand;
import org.freerealm.executor.command.SettlementAddAutomanagedResourceCommand;
 ...
 * @author Deniz ARIKAN
 */
public class NewSettlementHandler implements ControllerUpdateHandler {
    ...
    public void handleUpdate(FreeMarsController freeMarsController, CommandResult commandResult) {
        ...
        if (humanPlayer != null) {
            ...
            freeMarsController.executeViewCommand(new UpdateCoordinatePaintModelCommand(freeMarsController, updateCoordinates));
        }
