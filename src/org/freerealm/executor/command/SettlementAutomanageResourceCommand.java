 ...
 * @author Deniz ARIKAN
 */
public class SettlementAutomanageResourceCommand extends AbstractCommand {

    private Settlement settlement;
    private Resource resource;
    private Vector<ResourceProducer> resourceProducers;

    public SettlementAutomanageResourceCommand(Realm realm, Settlement settlement, Resource resource) {
        super(realm);
        this.settlement = settlement;
        this.resource = resource;
        resourceProducers = new Vector<ResourceProducer>();
    }
    ...
    public CommandResult execute() {
        ...
        while (iterator.hasNext()) {
            GeneralModifier[] modifiers = new GeneralModifier[]{settlement.getPlayer()};
