 ...
 * @author Deniz ARIKAN
 */
public class InitializeRealmCommand extends AbstractCommand {
    ...
    private void init() {
        ...
        getRealm().setTileImprovementTypeManager(new TileImprovementManagerXMLConverter().initializeFromNode(getRealm(), getRootNodeFromFile(configProperties.getProperty("tile_improvements_filename"))));

        SettlementImprovementManager settlementImprovementManager = new SettlementImprovementManager();
        (new SettlementImprovementManagerXMLWrapper(settlementImprovementManager)).initializeFromNode(getRealm(), getRootNodeFromFile(configProperties.getProperty("settlement_improvements_filename")));
        ...
        PopulationChangeManager populationChangeManager = new PopulationChangeManagerXMLConverter().initializeFromNode(getRealm(), getRootNodeFromFile(configProperties.getProperty("population_change_data_filename")));
