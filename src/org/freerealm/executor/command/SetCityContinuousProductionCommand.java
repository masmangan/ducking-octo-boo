 ...
 * @author Deniz ARIKAN
 */
public class SetCityContinuousProductionCommand extends AbstractCommand {
     ...
     * @param contiuousProduction New value for contiuous production mode
     */
    public SetCityContinuousProductionCommand(Settlement settlement, boolean contiuousProduction) {
