 ...
 * @author Deniz ARIKAN
 */
public class CreateMapCommand extends AbstractCommand {
     ...
     *
     * @param tileType All tiles in new map will be of this type
     * @param width Width of new map
     * @param height Height of new map
     */
    ...
    private TileType generateTileType(int probabilityTotal) {
        ...
        Iterator tileIterator = getRealm().getTileTypeManager().getTileTypesIterator();
