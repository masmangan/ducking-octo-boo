 ...
 * @author Deniz ARIKAN
 */
public class BonusResourceImplXMLConverter implements XMLConverter<BonusResourceImpl> {

    public String toXML(BonusResourceImpl bonusResource) {
        ...
        Iterator<TileType> iterator = bonusResource.getExistableTileTypesIterator();
        ...
        for (Node subNode = tileTypesNode.getFirstChild(); subNode != null; subNode = subNode.getNextSibling()) {
            if (subNode.getNodeType() == Node.ELEMENT_NODE) {
                if (subNode.getNodeName().equals("tileTypeId")) {
                    ...
                    bonusResourceImpl.addExistableTileType(tileType);
                }
            }
        }
