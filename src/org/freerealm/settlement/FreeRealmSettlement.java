...
public class FreeRealmSettlement extends FreeRealmPlayerMapItem implements Settlement {
    ...
    // <editor-fold defaultstate="collapsed" desc="Settlement improvement methods">
    ...
    public int getImprovementUpkeep() {
        ...
        upkeep = new SettlementImprovementUpkeepCostCalculator(upkeep, new GeneralModifier[]{getPlayer()}).getUpkeepCost();
        return upkeep;
    }
    ...
    public int getResourceModifier(Resource resource) {
        ...
        while (iterator.hasNext()) {
            SettlementImprovement settlementImprovement = iterator.next();
            if (settlementImprovement.isEnabled()) {
                modifier = modifier + settlementImprovement.getType().getResourceModifier(resource, true);
            }
        }
        return modifier;
    }
    ...
    private int getTaxIncomeModifier() {
        ...
        while (iterator.hasNext()) {
            SettlementImprovement settlementImprovement = iterator.next();
            if (settlementImprovement.isEnabled()) {
                modifier = modifier + settlementImprovement.getType().getTaxModifier();
            }
        }
        return modifier;
    }
    ...
    private int getProductionModifier() {
        ...
        while (iterator.hasNext()) {
            SettlementImprovement settlementImprovement = iterator.next();
            if (settlementImprovement.isEnabled()) {
                modifier = modifier + settlementImprovement.getType().getProductionModifier();
            }
        }
        modifier = modifier + getPlayer().getProductionModifier();
        return modifier;
    }
